...
@section('content')
    ...
    {{ html()->modelForm($article, 'PATCH', route('admin.articles.update', $article->id))->class('form')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="produtPic" id="J_pruductPic">
                                            <input name="pics" type="file" class="form-control J_uploadFile" default-val="<?php echo implode(',', (array)$article->covers_url); ?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{ html()->label('自定义热度 (真实=' . $article->pv . ')')->class('form-control-label')->for('fake_pv') }}
                    ...
                    <div class="form-group alert alert-info col-xs-12">
                        ...
                        @include('backend.includes.tag-input', ['selectedLabels' => $article->labels, 'labels' => $labels])
                    </div>
