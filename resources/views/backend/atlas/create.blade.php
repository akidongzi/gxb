...
@section('content')
    {{ html()->form('POST', route('admin.article_has_atlas.store'))->class('form-horizontal')->attribute('enctype',"multipart/form-data")->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">     
                            <div class="produtPic" id="J_pruductPic">
                                <input name="pics" type="file" class="form-control J_uploadFile" default-val=""/>
                            </div>
