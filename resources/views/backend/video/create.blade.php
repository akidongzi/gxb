...
@section('content')
    ...
    {{ html()->form('POST', route('admin.videos.store'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        视频管理
                        <small class="text-muted">添加视频</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <a href="javascript:void(0);" id="banner">
                                <img id="banner_up-img" src="/upLoad.jpg"/>
                            </a>
                            <a href="javascript:;" class="close" id="remove-poster" style="float:none;display:none;">&times;</a>
                        </div>
                        <input required value="" type="hidden" name="poster"
                               id="banner_up">
                    </div><!--form-group-->
