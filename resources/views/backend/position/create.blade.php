...
@section('content')
    {{ html()->form('POST', route('admin.positions.store'))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            位置管理
                            <small class="text-muted">创建位置</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                ...
                <div class="row mt-4 mb-4">
                    ...
                    <div class="form-group row">
                        {{ html()->label('模块')->class('col-md-2 form-control-label')->for('block_id') }}
                        <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            {{ html()->label('手机排序')->class('col-md-2 form-control-label')->for('msort') }}
