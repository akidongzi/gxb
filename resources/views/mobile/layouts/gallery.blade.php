...
<!-- S 图片查看器 -->
<div class="imglook">
	<div class="imglook__swiper swiper-container">
		<div class="imglook__wrapper swiper-wrapper">

		</div>
		<!-- Add Pagination -->
		<div class="imglook__pagination swiper-pagination"></div>
	</div>
</div>
<!-- E 图片查看器 -->

<!-- build:js scripts/app-plugins.min.js -->
<script src="{{ asset('mobile/scripts/jquery-1.10.2.js') }}"></script>
<script src="{{ asset('mobile/scripts/swiper.min.js') }}"></script>
<!-- endbuild -->

<!-- build:js scripts/index.min.js -->
<script src="{{ asset('mobile/scripts/minirefresh.js?123d') }}"></script>

<script src="{{ asset('mobile/scripts/public.js?1232') }}"></script>
<script src="{{ asset('mobile/scripts/common.js?201810191853') }}"></script>
<script src="{{ asset('mobile/scripts/images.js?123s') }}"></script>
<script src="{{ asset('mobile/themes/js/main.js?123') }}"></script>
<!-- endbuild -->
