...
@section('content')
    ...
    <div class="container_banner container_banner_zgg">
        <img class="banner_imgbg" src="/front/v3/images/banner_type6.png" alt="" width="100%" height="200">
        <h2 class="page-type_navbar pull-center">
    ...
    <!-- S 内容主体部分 -->
    <div class="container pull-center clearfix container_hwpt1">
                        ...
                        <ul class="container_info clearfix">
                            ...
                            @if ($item->coversNum == 0)
                                <li class="container_content pull-left" style="width:100%;">
                                    ...
                                    <span class="container_content-time">{{$item->source}} {{$item->published_at->format("Y-m-d") }}<em class="mark_tips"><i>国家</i><i>城市</i><i>大学</i></em></span>
                                </li>
    ...
    <div class="container_banner container_banner_zgg1">
        <img class="banner_imgbg" src="/front/v3/images/banner_zgg.png" alt="" width="1190" height="140">
        <ul>
            <li class="tit">中国馆</li>
